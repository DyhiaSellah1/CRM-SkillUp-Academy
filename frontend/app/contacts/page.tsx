    ...
    try {
      if (editingContactId !== null) {
        const res = await fetch(
          `http://localhost:3001/api/contacts/${editingContactId}`,
          {
            method: "PATCH",
            headers: {
            ...
            <tbody>
              {filteredContacts.map((contact) => (
                ...
                >
                  ...
                  <td className="p-4 text-sm text-slate-600">{contact.email}</td>
                  <td className="p-4">
          ...
          <div className="w-full max-w-2xl rounded-2xl bg-white shadow-2xl">
            <div className="flex items-center justify-between border-b border-slate-200 px-6 py-5">
              <h2 className="text-xl font-bold text-slate-900">
                {editingContactId !== null ? "Modifier le contact" : "Nouveau contact"}
              </h2>
            ...
            <form onSubmit={handleSubmitContact} className="p-6">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-end">
                ...
                >
                  {editingContactId !== null ? "Enregistrer" : "Créer le contact"}
                </button>
              </div>
            </form>
          </div>
